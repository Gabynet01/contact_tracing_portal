...
@section('title', 'Login | UPSA Contact Tracing')
...
@section('content')
    ...
    <div id="preloader">
        <div class="canvas">
            <img src="assets/img/app_logo.png" alt="UPSA Contact Tracing - Ghana" class="loader-logo">
                ...
                <div class="elisyam-bg background-01">
                    ...
                    <div class="authentication-col-content mx-auto">
                        <h1 class="gradient-text-01">
                            Welcome To UPSA Contact Tracing Portal!
                        </h1>
            ...
            <div class="col-xl-4 col-lg-6 col-md-7 my-auto no-padding">
                ...
                <div class="authentication-form mx-auto">
                    <div class="logo-centered">
                        <a href="/">
                            <img src="assets/img/app_logo.png" alt="UPSA Contact Tracing">
                        </a>
                    </div>
                    <h3>Sign In</h3>
                    <form id="loginForm">
