...
@section('title', 'Auto Contact Tracing Users | UPSA Contact Tracing Portal')
    ...
    <div class="w3-card-2 w3-white panel default-sidebar">
        ...
        <nav class="side-navbar box-scroll sidebar-scroll">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="/autoTracingUsers" class="active"><i class="ti ti-mobile"></i><span>Auto Tracing Users</span></a></li>
                                ...
                                <table id="appUsersDataTable" style="width:100%" class="table mb-0 table-striped table-hover manage-u-table table-css" role="grid" aria-describedby="sorting-table_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting">Traced User
                                            </th>

                                            <th class="sorting">Latitude
                                            </th>

                                            <th class="sorting">Longitude
                                            </th>

                                            <th class="sorting">Last Location
                                            </th>

                                            <th class="sorting">Device ID
                                            </th>
...
@push('pageScripts')
<script src="{{asset('assets/js/components/auto_tracing_users.js')}}"></script>
@endpush